...
Når du åpner en nettside i nettleseren din, så skjer det en rekke ting i bakgrunnen.
...
:::info
For å finne ut hvilken PC som skal motta forespørselen basert på domenenavnet, så bruker klienten en _DNS-server_. En DNS-server oversetter domenenavn til IP-adresser. For eksempel så oversetter DNS-serveren domenenavnet `google.com` til IP-adressen [`142.251.46.206`](http://142.251.46.206).
:::
