...
Når du har funnet ut hvor målet passer inn, så kan du skrive artikkelen din og legge den på rett plass i kodebasen. Du kan se på eksisterende mål artikler for å få en pekepinn på hvordan de skal se ut.
